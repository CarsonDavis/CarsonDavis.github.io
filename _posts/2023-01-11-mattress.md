...
## Mattress Design
Most mattresses are built with an overarching two-layer design principle: you have your <b>comfort layer</b> on top, which is soft and conforms to small variations in your body like the back of your head and your arms. Then there is the <b>support layer</b>, which is firmer and supports the heavier parts of your body like the hips. 
...
| Product                             | T  | ILD | lb/f3 | Price | Kept? |
|-------------------------------------|----|-----|-------|-------|-------|
...
### Motion Transfer
As a light sleeper, the complete absence of motion transfer was a primary design goal, and we did a LOT of tests with different layer configurations. We tried two different latexes on top, we tried both of them with memory foam on top. We tried putting the 1" HD36-HQ foam on top. And on and on.

Ultimately, latex really does transfer motion better. If you are sleeping directly on Dunlop 29 ILD latex, you _will_ feel the other person get in and out of bed. However, adding the 2" memory foam layer on top almost eliminates this, without losing the compressive spring-back the latex provides underneath.
...
How do I know that I like my particular DIY mattress? Well, my roommate also built a mattress, and we intentionally bought different layers. In addition to the aforementioned motion transfer tests, we also spent a couple months rearranging and trying different options for sleeping, and I can confidently say that I love my final design. 
